...
```javascript
const blinkingScore = Math.min(100, avgEAR * 500);
```
...
| 영역 | 거리 범위 | 점수 | 상태 |
|---|---|---|---|
| 중앙 | 0 - 0.04 | 100점 | 완벽한 시선 |
| 중앙 근처 | 0.04 - 0.08 | 90점 | 좋은 시선 |
| 중간 | 0.08 - 0.18 | 70점 | 보통 시선 |
| 외곽 | 0.18 이상 | 30점 | 시선 분산 |
